      ...
      >
        <Grid container sx={{ height: 'fit-content', width: '480px', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '10px', bgcolor: '#fff' }}>
          ...
          <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', p: '15px 12px' }}>
            <Button sx={{ fontSize: '13px', border: '1px solid #3b5998', color: '#3b5998', p: '8px 25px', textTransform: 'capitalize', fontWeight: '600', '&:hover': { bgcolor: '#3b5998', color: 'white' } }}> <span style={{ textTransform: 'lowercase', marginRight: '20px', fontSize: '16px', fontWeight: 'bold' }}>f</span>Log In via Facebook</Button>
            <Button sx={{ fontSize: '13px', border: '1px solid #dc4d28', color: '#dc4d28', p: '8px 25px', textTransform: 'capitalize', fontWeight: '600', '&:hover': { bgcolor: ' #dc4d28', color: 'white' } }}><span style={{ marginRight: '20px', fontSize: '16px', fontWeight: 'bold' }}>G</span>Log In via Google</Button>
          </Grid>
        </Grid>
      </Modal>
